...
import React, { Component, useState, useEffect } from 'react'
 ...
 class Sub_accommodation_section extends Component {
    ...
    return (
        ...
        <div className='subSection-comments'>
                         ...
                         {    videoDetails && videoDetails.map(Videodetails1 => {
                            if(Videodetails1.id === "fc5261d1-58a0-47e4-9c19-2b7a1715fa1b"){
            ...
            <div className="next-videos">
                {
                    Videos && Videos.map(video => {
                        ...
                        if(video.id !== "fc5261d1-58a0-47e4-9c19-2b7a1715fa1b"){
                            return(
...
export default Sub_accommodation_section;