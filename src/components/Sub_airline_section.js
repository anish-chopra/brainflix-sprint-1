...
import React, { Component, useState, useEffect } from 'react'
 ...
 class Sub_airline_section extends Component {
    ...
    return (
        ...
        <div className='subSection-comments'>
                         ...
                         {    videoDetails && videoDetails.map(Videodetails1 => {
                            if(Videodetails1.id === "1b964601-a6dd-4fcc-b5f3-1000338c9557"){
            ...
            <div className="next-videos">
                {
                    Videos && Videos.map(video => {
                        ...
                        if(video.id !== "1b964601-a6dd-4fcc-b5f3-1000338c9557"){
                            return(
...
export default Sub_airline_section;