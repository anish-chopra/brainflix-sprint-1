...
import React, { Component, useState, useEffect } from 'react'
 ...
 class Sub_health_section extends Component {
    ...
    return (
        ...
        <div className='subSection-comments'>
                         ...
                         {    videoDetails && videoDetails.map(Videodetails1 => {
                            if(Videodetails1.id === "b6f35f03-7936-409b-bd2a-446bcc5f30e7"){
            ...
            <div className="next-videos">
                {
                    Videos && Videos.map(video => {
                        ...
                        if(video.id !== "b6f35f03-7936-409b-bd2a-446bcc5f30e7"){
                            return(
...
export default Sub_health_section;