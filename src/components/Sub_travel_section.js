...
import React, { Component, useState, useEffect } from 'react'
 ...
 class Sub_travel_section extends Component {
    ...
    return (
        ...
        <div className='subSection-comments'>
                         ...
                         {    videoDetails && videoDetails.map(Videodetails1 => {
                            if(Videodetails1.id === "c05b9a93-8682-4ab6-aff2-92ebb4bbfc14"){
            ...
            <div className="next-videos">
                {
                    Videos && Videos.map(video => {
                        ...
                        if(video.id !== "c05b9a93-8682-4ab6-aff2-92ebb4bbfc14"){
                            return(
...
export default Sub_travel_section;