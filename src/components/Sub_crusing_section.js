...
import React, { Component, useState, useEffect } from 'react'
 ...
 class Sub_crusing_section extends Component {
    ...
    return (
        ...
        <div className='subSection-comments'>
                         ...
                         {    videoDetails && videoDetails.map(Videodetails1 => {
                            if(Videodetails1.id === "99478bed-6428-49ed-8eaa-f245a5414336"){
            ...
            <div className='comments-section'>
                <span className='description-subheader comments-heading'> 2 Comments</span>
            ...
            <div className="next-videos">
                {
                    Videos && Videos.map(video => {
                        ...
                        if(video.id !== "99478bed-6428-49ed-8eaa-f245a5414336"){
                            return(
...
export default Sub_crusing_section;