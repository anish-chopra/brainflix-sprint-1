...
import React, { Component, useState, useEffect } from 'react'
 ...
 class Sub_chemonix_section extends Component {
    ...
    return (
        ...
        <div className='subSection-comments'>
                         ...
                         {    videoDetails && videoDetails.map(Videodetails1 => {
                            if(Videodetails1.id === "25ce5d91-a262-4dcf-bb87-42b87546bcfa"){
            ...
            <div className="next-videos">
                {
                    Videos && Videos.map(video => {
                        ...
                        if(video.id !== "25ce5d91-a262-4dcf-bb87-42b87546bcfa"){
                            return(
...
export default Sub_chemonix_section;