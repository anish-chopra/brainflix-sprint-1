...
import React, { Component, useState, useEffect } from 'react'
 ...
 class Sub_train_section extends Component {
    ...
    return (
        ...
        <div className='subSection-comments'>
                         ...
                         {    videoDetails && videoDetails.map(Videodetails1 => {
                            if(Videodetails1.id === "76ca28c0-7dea-4553-887f-8e5129a80fc3"){
            ...
            <div className="next-videos">
                {
                    Videos && Videos.map(video => {
                        ...
                        if(video.id !== "76ca28c0-7dea-4553-887f-8e5129a80fc3"){
                            return(
...
export default Sub_train_section;